...
data class ListItemState(
    val headline: br.com.mob1st.core.design.atoms.properties.Text,
    val supporting: br.com.mob1st.core.design.atoms.properties.Text? = null,
    ...
    @JvmInline
    value class Text(val value: br.com.mob1st.core.design.atoms.properties.Text) : Trailing
