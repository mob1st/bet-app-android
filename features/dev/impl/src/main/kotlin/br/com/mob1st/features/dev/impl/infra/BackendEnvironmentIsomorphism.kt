...
private fun domainToCacheMorphism() =
    Morphism<BackendEnvironment, String?> {
        when (it) {
...
private fun cacheToDomainMorphism(isReleaseBuild: Boolean) =
    Morphism<String?, BackendEnvironment> {
        when (it) {
