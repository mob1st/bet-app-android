...
internal class ProjectSettingsRepositoryImpl(
    ...
    private val beEnvIsomorphism =
        backendEnvironmentIsomorphism(
            buildInfoDataSource.data.isReleaseBuild,
        )

    override fun get(): Flow<ProjectSettings> =
    ...
    override suspend fun set(backendEnvironment: BackendEnvironment) =
        withContext(io) {
